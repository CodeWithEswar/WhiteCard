    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col bg-sidebar border-r border-sidebar-border/80 group-data-[variant=floating]:rounded-md group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border"
        >
          {children}
        </div>
      </div>
