          ...
          <DropdownMenuTrigger
            render={
              <button
                ...
                className="size-9 rounded-md bg-muted/70 border border-border/80 flex items-center justify-center font-bold text-xs text-foreground hover:border-foreground/20 transition-colors overflow-hidden outline-hidden focus-visible:ring-2 focus-visible:ring-ring"
              />
            }
          >
            {userAvatar ? (
