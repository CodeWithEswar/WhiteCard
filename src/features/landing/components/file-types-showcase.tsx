...
const formats = [
  {
    ...
    name: 'PDF Documents',
    ext: '.pdf',
    desc: 'Passports, identity cards, degrees, transcripts, and official contracts',
    icon: Pdf01Icon,
  },
  {
    badge: 'IMG',
    name: 'Images',
    ext: '.png, .jpg, .webp',
    desc: 'High-resolution identity card photos, certificates, and document scans',
    icon: Image01Icon,
  },
  {
    badge: 'ZIP',
    name: 'ZIP Archives',
    ext: '.zip',
    desc: 'Multi-semester bundles, academic record archives, and bundled folders',
    icon: Zip01Icon,
  },
  {
    badge: 'DOC',
    name: 'Documents',
    ext: '.doc, .docx',
    desc: 'Letters of recommendation, statements of purpose, and reference documents',
    icon: File01Icon,
  },
  {
    badge: 'XLS',
    name: 'Spreadsheets',
    ext: '.xlsx, .csv',
    desc: 'Grade registers, mark calculations, fee audits, and tabulated lists',
    icon: Table01Icon,
  },
  {
    badge: 'TXT',
    name: 'Text Files',
    ext: '.txt, .md',
    desc: 'Plain text records, reference details, and application markdown notes',
    icon: DocumentCodeIcon,
  },
] as const

export function FileTypesShowcase() {
  return (
        ...
        <div className="max-w-[760px] mx-auto text-center space-y-4 mb-16">
          ...
          <Reveal delay={0.06}>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-foreground leading-tight">
              Keep the original files you already have.
            </h2>
          </Reveal>
          <Reveal delay={0.12}>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto">
              White Card keeps your original file intact so it can be downloaded later in the format you uploaded.
            </p>
          </Reveal>
        </div>

        {/* 6 Compact Items: Desktop 6, Tablet 3x2, Mobile 2 cols */}
