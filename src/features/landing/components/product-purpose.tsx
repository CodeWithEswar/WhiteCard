...
const steps = [
  {
    num: '01',
    title: 'Sign in',
    desc: 'Instant Google sign-in without a separate password',
    icon: GoogleIcon,
  },
  {
    num: '02',
    title: 'Choose a space',
    desc: 'Keep Government records and Student credentials separate',
    icon: Folder01Icon,
  },
  {
    num: '03',
    title: 'Upload',
    desc: 'Deposit original PDFs, images, archives and documents',
    icon: Upload01Icon,
  },
  {
    num: '04',
    title: 'Organize',
    desc: 'Assign color tags, metadata, and optional expiry dates',
    icon: Tag01Icon,
  },
  {
    num: '05',
    title: 'Access',
    desc: 'Search quickly, download original files, or share safely',
...
export function ProductPurpose() {
  ...
  return (
    ...
    >
      {/* Background Parallax Layer: Slow Dot Parallax (y: 16 -> -16px) */}
      <ParallaxLayer
        ...
        <div className="max-w-[760px] mx-auto text-center space-y-4 mb-16">
          ...
          <Reveal delay={0.12}>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto">
              White Card gives you one clear place to keep official records and academic certificates without turning personal document management into a complex system.
            </p>
          </Reveal>
        </div>

        {/* 5-Step Clear Conceptual Flow */}
        <Reveal delay={0.18}>
